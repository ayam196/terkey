...
class Terkey:
  ...
  def about(self):
    ...
    {a}https://t.me/Elmriakrmva{c}
    My Channels
    {a}https://youtube.com/channel/UCV3BPHLtmhb0MZjbX4FpUWA{c}
    And if you want to give me some money, you can visit
    {a}https://saweria.co/DinoBot{c}
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://t.me/Elmriakrmva'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
