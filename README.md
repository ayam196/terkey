...
* `$ pkg install python`
* `$ pkg install git`
* `$ git clone https://github.com/ayam196/terkey`
* `$ cd terkey`
* `$ python terkey.py`
...
```pkg update && pkg upgrade;pkg install python git;git clone https://github.com/ayam196/terkey;cd terkey;python terkey.py```
...
> Thanks !
## Author
So many information about me in internet, just type ['Alia Cans'](https://t.me/Elmriakrmva) in your browser !
